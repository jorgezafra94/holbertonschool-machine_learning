# Pandas
this is an intro of the basics of pandas
...
## Task2 - From File
Write a function def from_file(filename, delimiter): that loads data from a file as a pd.DataFrame:<br>
<br>
...
## Task3 - Rename
Complete the script below to perform the following:<br>
<br>
...
$ ./14-visualize.py
```
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/pipeline/0x00-pandas/grafica.png)
