...
Here we are going to learn the some of the most important and disruptive Architectures of CNN<br>
And the models were built from the information of the papers.<br>
* to compare your outputs and the expected outputs use [this](https://text-compare.com/es/)<br>
# GoogLeNet
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/googlenet.png)<br>
if you wanna see the paper of the construction of the GoogLeNet click [Here](https://arxiv.org/pdf/1409.4842.pdf)<br>
Here we are going to build that CNN<br>
### Task0 - Inception Block
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/inception-block.png)<br>
Write a function `def inception_block(A_prev, filters):` that builds an inception block as described in [Going Deeper with Convolutions (2014)](https://arxiv.org/pdf/1409.4842.pdf):<br>
<br>
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ cat 0-main.py 
#!/usr/bin/env python3
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./0-main.py 
...
__________________________________________________________________________________________________
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$
```
### Task1 - Inception Network(GoogLeNet)
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/table%20googlenet.png)<br>
Write a function `def inception_network():` that builds the inception network as described in  [Going Deeper with Convolutions (2014)](https://arxiv.org/pdf/1409.4842.pdf):<br>
<br>
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ cat 1-main.py 
#!/usr/bin/env python3
...
your output has to be the same as:

```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./1-main.py 
__________________________________________________________________________________________________
Layer (type)                    Output Shape         Param #     Connected to                     
==================================================================================================
input_1 (InputLayer)            (None, 224, 224, 3)  0                                            
...
# ResNet
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/resnet.png)<br>
if you wanna see the paper of the construction of the ResNet click [Here](https://arxiv.org/pdf/1512.03385.pdf)<br>
Here we are going to build that CNN<br>
### Task2 - Identity Block
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/identity%20block.png)<br>
Write a function `def identity_block(A_prev, filters):` that builds an identity block as described in [Deep Residual Learning for Image Recognition (2015)](https://arxiv.org/pdf/1512.03385.pdf):<br>
<br>
* A_prev is the output from the previous layer
...
your ouotput has to be

```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./2-main.py 
__________________________________________________________________________________________________
Layer (type)                    Output Shape         Param #     Connected to                     
==================================================================================================
...
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ 
```
### Task3 - Projection Block
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/projection%20block.png)<br>
Write a function `def projection_block(A_prev, filters, s=2):` that builds a projection block as described in  [Deep Residual Learning for Image Recognition (2015)](https://arxiv.org/pdf/1512.03385.pdf):<br>
<br>
* A_prev is the output from the previous layer
* filters is a tuple or list containing F11, F3, F12, respectively:
* * F11 is the number of filters in the first 1x1 convolution
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./3-main.py 
__________________________________________________________________________________________________
Layer (type)                    Output Shape         Param #     Connected to                     
==================================================================================================
input_1 (InputLayer)            (None, 224, 224, 3)  0                                            
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./4-main.py 
__________________________________________________________________________________________________
Layer (type)                    Output Shape         Param #     Connected to                     
==================================================================================================
input_1 (InputLayer)            (None, 224, 224, 3)  0                                            
...
```
# DenseNet
if you wanna see the paper of the construction of the ResNet click [Here](https://arxiv.org/pdf/1608.06993.pdf)<br>
Here we are going to build that CNN<br>

### Task5 - Dense Block
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/dense%20block.png)<br>
Write a function `def dense_block(X, nb_filters, growth_rate, layers):` that builds a dense block as described in [Densely Connected Convolutional Networks](https://arxiv.org/pdf/1608.06993.pdf):<br>
<br>
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./5-main.py
__________________________________________________________________________________________________
Layer (type)                    Output Shape         Param #     Connected to                     
==================================================================================================
...
### Task6 - Transition Layer
Write a function `def transition_layer(X, nb_filters, compression):` that builds a transition layer as described in[Densely Connected Convolutional Networks](https://arxiv.org/pdf/1608.06993.pdf):<br>
<br>
* X is the output from the previous layer
* nb_filters is an integer representing the number of filters in X
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./6-main.py
...
### Task7- DenseNet-121
![](https://github.com/jorgezafra94/holbertonschool-machine_learning/blob/master/supervised_learning/0x08-deep_cnns/pictures/table%20denseNet.png)<br>
Write a function `def densenet121(growth_rate=32, compression=1.0):` that builds the DenseNet-121 architecture as described in [Densely Connected Convolutional Networks](https://arxiv.org/pdf/1608.06993.pdf):<br>
<br>
...
```
ubuntu@ml:~/supervised_learning/0x08-deep_cnns$ ./7-main.py 
__________________________________________________________________________________________________
Layer (type)                    Output Shape         Param #     Connected to                     
==================================================================================================
input_1 (InputLayer)            (None, 224, 224, 3)  0                                            
